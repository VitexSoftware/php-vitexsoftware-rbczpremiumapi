...
$apiInstance = new \OpenAPI\Client\RaiffeisenBank\GetStatementListApi(new \GuzzleHttp\Client(['cert' => ['test_cert.p12', 'test12345678'], 'debug' => true]));
...
$request_body = new \OpenAPI\Client\Model\GetStatementsRequest(['account_number' => '1899297002', 'currency' => 'CZK', 'statementLine' => 'MAIN']);
