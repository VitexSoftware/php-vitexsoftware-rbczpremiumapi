 ...
 */
class GetBatchDetail400Response implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getBatchDetail_400_response';
     ...
     * Sets error.
     *
     * @param null|string $error invalid input
     *
     * @return self
     */
