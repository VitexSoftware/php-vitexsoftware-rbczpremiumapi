 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterParty implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_relatedParties_counterParty';
    ...
    protected static array $openAPITypes = [
        'name' => 'string',
        'postalAddress' => '\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyPostalAddress',
        ...
        'account' => '\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyAccount',
    ];
    ...
    protected static array $openAPINullables = [
        'name' => false,
        'postalAddress' => false,
        'organisationIdentification' => false,
        'account' => false,
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('organisationIdentification', $data ?? [], null);
     ...
     * Sets name.
     *
     * @param null|string $name Bank account name
     *
     * @return self
     */
     ...
     * Gets postalAddress.
     *
     * @return null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyPostalAddress
     */
     ...
     * Sets postalAddress.
     *
     * @param null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyPostalAddress $postalAddress postalAddress
     *
     * @return self
     */
     ...
     *
     * @return null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyOrganisationIdentification
     */
     ...
     *
     * @param null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyOrganisationIdentification $organisationIdentification organisationIdentification
     *
     * @return self
     */
    public function setOrganisationIdentification($organisationIdentification)
    {
        if (null === $organisationIdentification) {
            throw new \InvalidArgumentException('non-nullable organisationIdentification cannot be null');
        }
     ...
     * Gets account.
     *
     * @return null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyAccount
     */
     ...
     * Sets account.
     *
     * @param null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyAccount $account account
     *
     * @return self
     */
