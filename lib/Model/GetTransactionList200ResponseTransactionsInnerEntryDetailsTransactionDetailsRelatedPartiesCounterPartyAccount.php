 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyAccount implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_relatedParties_counterParty_account';
     ...
     * Sets iban.
     *
     * @param null|string $iban IBAN code of the bank account if available
     *
     * @return self
     */
     ...
     *
     * @param null|string $accountNumberPrefix Prefix part of the bank account number (only for czech accounts)
     *
     * @return self
     */
     ...
     * Sets accountNumber.
     *
     * @param null|string $accountNumber Base part of the bank account number in czech fromat or in foreign format
     *
     * @return self
     */
