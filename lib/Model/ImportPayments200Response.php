 ...
 */
class ImportPayments200Response implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'importPayments_200_response';
    ...
    {
        $this->setIfExists('batchFileId', $data ?? [], null);
    }
    ...
    {
        return $this->container['batchFileId'];
    }

    /**
     * Sets batchFileId.
     *
     * @param null|int $batchFileId ID of created batch file
     *
     * @return self
     */
    public function setBatchFileId($batchFileId)
    {
        if (null === $batchFileId) {
            throw new \InvalidArgumentException('non-nullable batchFileId cannot be null');
        }

        $this->container['batchFileId'] = $batchFileId;
