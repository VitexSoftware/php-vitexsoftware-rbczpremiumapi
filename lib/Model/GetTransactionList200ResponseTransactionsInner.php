...
class GetTransactionList200ResponseTransactionsInner implements \ArrayAccess, \JsonSerializable, ModelInterface
{
    ...
    public const CREDIT_DEBIT_INDICATION_CRDT = 'CRDT';

    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'getTransactionList_200_response_transactions_inner';
    ...
    protected static array $openAPITypes = [
        ...
        'amount' => '\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerAmount',
        'creditDebitIndication' => 'string',
        'bookingDate' => '\DateTime',
        'valueDate' => '\DateTime',
        'bankTransactionCode' => '\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerBankTransactionCode',
        'entryDetails' => '\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetails',
    ];
    ...
    protected static array $setters = [
        ...
        'amount' => 'setAmount',
        'creditDebitIndication' => 'setCreditDebitIndication',
    ...
    protected static array $getters = [
        ...
        'amount' => 'getAmount',
        'creditDebitIndication' => 'getCreditDebitIndication',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('creditDebitIndication', $data ?? [], null);
    ...
    {
        return [
            self::CREDIT_DEBIT_INDICATION_DBIT,
            self::CREDIT_DEBIT_INDICATION_CRDT,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['entryReference'] === null) {
            $invalidProperties[] = "'entryReference' can't be null";
        }
        ...
        if ($this->container['creditDebitIndication'] === null) {
            $invalidProperties[] = "'creditDebitIndication' can't be null";
        }

        $allowedValues = $this->getCreditDebitIndicationAllowableValues();

        if (null !== $this->container['creditDebitIndication'] && !\in_array($this->container['creditDebitIndication'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'creditDebitIndication', must be one of '%s'",
                $this->container['creditDebitIndication'],
                implode("', '", $allowedValues),
            );
        }

        if ($this->container['bankTransactionCode'] === null) {
            $invalidProperties[] = "'bankTransactionCode' can't be null";
        }
     ...
     * Sets entryReference.
     *
     * @param string $entryReference unique identification of the realized transaction
     *
     * @return self
     */
     ...
     * Gets amount.
     *
     * @return \VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerAmount
     */
     ...
     * Sets amount.
     *
     * @param \VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerAmount $amount amount
     *
     * @return self
     */
    ...
    /**
     * Gets creditDebitIndication.
     *
     * @return string
     */
    public function getCreditDebitIndication()
    {
        return $this->container['creditDebitIndication'];
    }

    /**
     * Sets creditDebitIndication.
     *
     * @param string $creditDebitIndication creditDebitIndication
     *
     * @return self
     */
    public function setCreditDebitIndication($creditDebitIndication)
    {
        if (null === $creditDebitIndication) {
            throw new \InvalidArgumentException('non-nullable creditDebitIndication cannot be null');
        }

        $allowedValues = $this->getCreditDebitIndicationAllowableValues();

        if (!\in_array($creditDebitIndication, $allowedValues, true)) {
        ...
        $this->container['creditDebitIndication'] = $creditDebitIndication;
     ...
     * Sets bookingDate.
     *
     * @param null|\DateTime $bookingDate date of payment processing/posting by the bank
     *
     * @return self
     */
     ...
     * Sets valueDate.
     *
     * @param null|\DateTime $valueDate Transaction date; value date; date which is used to count interest; e.g. date when money were withdrawn from ATM.
     *
     * @return self
     */
     ...
     *
     * @return \VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerBankTransactionCode
     */
     ...
     *
     * @param \VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerBankTransactionCode $bankTransactionCode bankTransactionCode
     *
     * @return self
     */
     ...
     * Gets entryDetails.
     *
     * @return null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetails
     */
     ...
     * Sets entryDetails.
     *
     * @param null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetails $entryDetails entryDetails
     *
     * @return self
     */
