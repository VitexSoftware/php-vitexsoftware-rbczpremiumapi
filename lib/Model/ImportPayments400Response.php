...
class ImportPayments400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets error
     *
     * @param string|null $error * INVALID_BATCH_IMPORT_FORMAT - Batch-Import-Format unsupported * BATCH_CONTENT_INVALID - Batch content doesn't match to declared Batch-Import-Format * BATCH_ALREADY_IMPORTED - Batch has already been imported (based on checksum)
     *
     * @return self
     */
