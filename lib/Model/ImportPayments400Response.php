...
class ImportPayments400Response implements \ArrayAccess, \JsonSerializable, ModelInterface
{
    ...
    public const ERROR_BATCH_CONTENT_INVALID = 'BATCH_CONTENT_INVALID';
    public const ERROR_BATCH_ALREADY_IMPORTED = 'BATCH_ALREADY_IMPORTED';

    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'importPayments_400_response';
    ...
    {
        return [
            self::ERROR_INVALID_BATCH_IMPORT_FORMAT,
            self::ERROR_BATCH_CONTENT_INVALID,
            self::ERROR_BATCH_ALREADY_IMPORTED,
        ];
    }
     ...
     * Sets error.
     *
     * @param null|string $error * INVALID_BATCH_IMPORT_FORMAT - Batch-Import-Format unsupported * BATCH_CONTENT_INVALID - Batch content doesn't match to declared Batch-Import-Format * BATCH_ALREADY_IMPORTED - Batch has already been imported (based on checksum)
     *
     * @return self
     */
