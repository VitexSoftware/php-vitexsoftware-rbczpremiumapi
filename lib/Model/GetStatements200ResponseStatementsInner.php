 ...
 */
class GetStatements200ResponseStatementsInner implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getStatements_200_response_statements_inner';
    ...
    protected static array $setters = [
        ...
        'statementFormats' => 'setStatementFormats',
    ];
    ...
    protected static array $getters = [
        ...
        'statementFormats' => 'getStatementFormats',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('statementNumber', $data ?? [], null);
        $this->setIfExists('dateFrom', $data ?? [], null);
        $this->setIfExists('dateTo', $data ?? [], null);
        $this->setIfExists('currency', $data ?? [], null);
        $this->setIfExists('statementFormats', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['statementNumber'] === null) {
            $invalidProperties[] = "'statementNumber' can't be null";
        }
        ...
        if ($this->container['statementFormats'] === null) {
            $invalidProperties[] = "'statementFormats' can't be null";
        }
    ...
    {
        return $this->container['statementNumber'];
    }

    /**
     * Sets statementNumber.
     *
     * @param string $statementNumber number of the statement
     *
     * @return self
     */
    public function setStatementNumber($statementNumber)
    {
        if (null === $statementNumber) {
            throw new \InvalidArgumentException('non-nullable statementNumber cannot be null');
        }

        $this->container['statementNumber'] = $statementNumber;
     ...
     * Sets dateFrom.
     *
     * @param \DateTime $dateFrom valid date from for statement
     *
     * @return self
     */
     ...
     * Sets dateTo.
     *
     * @param \DateTime $dateTo valid date to for statement
     *
     * @return self
     */
     ...
     * Sets currency.
     *
     * @param null|string $currency currency of the statement
     *
     * @return self
     */
    ...
    /**
     * Gets statementFormats.
     *
     * @return string[]
     */
    public function getStatementFormats()
    {
        return $this->container['statementFormats'];
    }

    /**
     * Sets statementFormats.
     *
     * @param string[] $statementFormats set of document available formats (always in upper case notation)
     *
     * @return self
     */
    public function setStatementFormats($statementFormats)
    {
        if (null === $statementFormats) {
            throw new \InvalidArgumentException('non-nullable statementFormats cannot be null');
        }

        $this->container['statementFormats'] = $statementFormats;
