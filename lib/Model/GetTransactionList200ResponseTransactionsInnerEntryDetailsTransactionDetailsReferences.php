 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsReferences implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_references';
    ...
    {
        $this->setIfExists('endToEndIdentification', $data ?? [], null);
    }
     ...
     *
     * @param null|string $endToEndIdentification Originator reference ID - End to End ID; The Originator's reference of the transaction
     *
     * @return self
     */
    public function setEndToEndIdentification($endToEndIdentification)
    {
        if (null === $endToEndIdentification) {
            throw new \InvalidArgumentException('non-nullable endToEndIdentification cannot be null');
        }
