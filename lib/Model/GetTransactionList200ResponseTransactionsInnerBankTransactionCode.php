 ...
 */
class GetTransactionList200ResponseTransactionsInnerBankTransactionCode implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactionList_200_response_transactions_inner_bankTransactionCode';
     ...
     * Sets code.
     *
     * @param string $code Transaction code in ISO20022 camt.53 format (e.g. 10000101000 - Odchozi tuzemska platba).
     *
     * @return self
     */
