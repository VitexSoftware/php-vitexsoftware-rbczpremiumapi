 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyOrganisationIdentification implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_relatedParties_counterParty_organisationIdentification';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bicOrBei', $data ?? [], null);
     ...
     * Sets bicOrBei.
     *
     * @param null|string $bicOrBei SWIFT/BIC code of the bank
     *
     * @return self
     */
    ...
    {
        if (null === $bicOrBei) {
            throw new \InvalidArgumentException('non-nullable bicOrBei cannot be null');
        }
     ...
     * Sets bankCode.
     *
     * @param null|string $bankCode Proprietary bank code in local format (e.g. 5500) or in foreign format.
     *
     * @return self
     */
     ...
     * Gets postalAddress.
     *
     * @return null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyOrganisationIdentificationPostalAddress
     */
     ...
     * Sets postalAddress.
     *
     * @param null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyOrganisationIdentificationPostalAddress $postalAddress postalAddress
     *
     * @return self
     */
