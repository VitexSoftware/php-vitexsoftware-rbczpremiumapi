 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsInstructedAmount implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_instructedAmount';
     ...
     * Sets currency.
     *
     * @param string $currency Currency code of the amount
     *
     * @return self
     */
     ...
     * Sets exchangeRate.
     *
     * @param null|float $exchangeRate exchangeRate
     *
     * @return self
     */
