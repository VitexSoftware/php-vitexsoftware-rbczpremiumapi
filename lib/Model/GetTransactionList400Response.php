...
class GetTransactionList400Response implements \ArrayAccess, \JsonSerializable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactionList_400_response';
     ...
     * Sets error.
     *
     * @param null|string $error Invalid date. Parameter `from` must not be older than 90 days.
     *
     * @return self
     */
