 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRemittanceInformation implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_remittanceInformation';
    ...
    protected static array $setters = [
        ...
        'originatorMessage' => 'setOriginatorMessage',
    ];
    ...
    protected static array $getters = [
        ...
        'originatorMessage' => 'getOriginatorMessage',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('originatorMessage', $data ?? [], null);
    }
     ...
     * Sets unstructured.
     *
     * @param null|string $unstructured Information from or for counter party. Information for creditor.
     *
     * @return self
     */
     ...
     *
     * @return null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRemittanceInformationCreditorReferenceInformation
     */
     ...
     *
     * @param null|\VitexSoftware\Raiffeisenbank\Model\GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRemittanceInformationCreditorReferenceInformation $creditorReferenceInformation creditorReferenceInformation
     *
     * @return self
     */
    ...
    /**
     * Gets originatorMessage.
     *
     * @return null|string
     */
    public function getOriginatorMessage()
    {
        return $this->container['originatorMessage'];
    }

    /**
     * Sets originatorMessage.
     *
     * @param null|string $originatorMessage Private description of the transaction. Only available to account holder.
     *
     * @return self
     */
    public function setOriginatorMessage($originatorMessage)
    {
        if (null === $originatorMessage) {
            throw new \InvalidArgumentException('non-nullable originatorMessage cannot be null');
        }

        $this->container['originatorMessage'] = $originatorMessage;
