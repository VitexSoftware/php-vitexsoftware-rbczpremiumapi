...
class GetBatchDetailApi
{
    ...
    {
        [$response] = $this->getBatchDetailWithHttpInfo($xRequestId, $batchFileId, $contentType);
    ...
    public function getBatchDetailWithHttpInfo($xRequestId, $batchFileId, string $contentType = self::contentTypes['getBatchDetail'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\VitexSoftware\Raiffeisenbank\Model\GetBatchDetail200Response' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();

                        if ('\VitexSoftware\Raiffeisenbank\Model\GetBatchDetail200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VitexSoftware\Raiffeisenbank\Model\GetBatchDetail200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 400:
                    if ('\VitexSoftware\Raiffeisenbank\Model\GetBatchDetail400Response' === '\SplFileObject') {
                        $content = $response->getBody(); // stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();

                        if ('\VitexSoftware\Raiffeisenbank\Model\GetBatchDetail400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, \JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VitexSoftware\Raiffeisenbank\Model\GetBatchDetail400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 401:
            ...
            $returnType = '\VitexSoftware\Raiffeisenbank\Model\GetBatchDetail200Response';
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VitexSoftware\Raiffeisenbank\Model\GetBatchDetail400Response',
                        $e->getResponseHeaders(),
                    );
                    $e->setResponseObject($data);
